...
--
-- PRIOR 5 (build_group only): coarsest fallback; aggregate 6010 across
-- all champions and roles for each (build_group, phase).

TRUNCATE TABLE game_data_filtered.synergy_1vx_temporal_prior_build;

INSERT INTO game_data_filtered.synergy_1vx_temporal_prior_build
SELECT
    'train' AS split,
    multiIf(
