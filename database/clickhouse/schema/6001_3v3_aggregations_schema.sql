...
CREATE TABLE IF NOT EXISTS game_data_filtered.matchup_3v3
(
    ...
    left_championid_3 Int32,
    left_championname_3 LowCardinality(String),
    left_teamposition_3 LowCardinality(String),
    left_build_3 LowCardinality(String),
    ...
    right_championid_3 Int32,
    right_championname_3 LowCardinality(String),
    right_teamposition_3 LowCardinality(String),
    right_build_3 LowCardinality(String),
    matchups UInt64,
    left_wins UInt64,
    right_wins UInt64,
