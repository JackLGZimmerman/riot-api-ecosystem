...
SELECT t.*
FROM game_data.metadata AS t FINAL
...
SELECT t.*
FROM game_data.tl_participant_stats AS t FINAL
WHERE t.matchid IN (SELECT matchid FROM game_data_filtered.valid_game_ids);
...
SELECT t.*
FROM game_data.tl_ck_victim_damage_dealt AS t FINAL
WHERE t.matchid IN (SELECT matchid FROM game_data_filtered.valid_game_ids);
...
SELECT t.*
FROM game_data.tl_ck_victim_damage_received AS t FINAL
WHERE t.matchid IN (SELECT matchid FROM game_data_filtered.valid_game_ids);
