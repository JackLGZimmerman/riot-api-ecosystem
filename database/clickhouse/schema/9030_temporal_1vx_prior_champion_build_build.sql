...
--
-- PRIOR 4 (champion + build_group): aggregate 6010 across all roles for
-- each (championid, build_group, phase). build_group collapses sibling
-- pairs; unpaired builds remain their own group.

TRUNCATE TABLE game_data_filtered.synergy_1vx_temporal_prior_champion_build;

INSERT INTO game_data_filtered.synergy_1vx_temporal_prior_champion_build
SELECT
    'train' AS split,
    t.championid,
