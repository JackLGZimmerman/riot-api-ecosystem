...
| TLE_S_062 | First Blood Events Per-Minute Bin | game_data.tl_champion_special_kill | Per-killer first blood count per minute bin. | countIf(killtype = 'KILL_FIRST_BLOOD') grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | killtype, killerid, matchid, timestamp |
| TLE_S_063 | Ace Events Per-Minute Bin | game_data.tl_champion_special_kill | Per-killer ace count per minute bin. | countIf(killtype = 'KILL_ACE') grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | killtype, killerid, matchid, timestamp |
| TLE_S_064 | Multi-Kill Events Per-Minute Bin | game_data.tl_champion_special_kill | Per-killer multi-kill event count per minute bin. | countIf(killtype = 'KILL_MULTI') grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | killtype, killerid, matchid, timestamp |
| TLE_S_065 | Double-Kill Total Kills Per-Minute Sum | game_data.tl_champion_special_kill | Per-killer summed kills contributed by double-kill events per minute bin. | sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 2) grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | killtype, multikilllength, killerid, matchid, timestamp |
| TLE_S_066 | Triple-Kill Total Kills Per-Minute Sum | game_data.tl_champion_special_kill | Per-killer summed kills contributed by triple-kill events per minute bin. | sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 3) grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | killtype, multikilllength, killerid, matchid, timestamp |
| TLE_S_067 | Quadra-Kill Total Kills Per-Minute Sum | game_data.tl_champion_special_kill | Per-killer summed kills contributed by quadra-kill events per minute bin. | sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 4) grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | killtype, multikilllength, killerid, matchid, timestamp |
| TLE_S_068 | Penta-Kill Total Kills Per-Minute Sum | game_data.tl_champion_special_kill | Per-killer summed kills contributed by penta-kill events per minute bin. | sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 5) grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | killtype, multikilllength, killerid, matchid, timestamp |
| TLE_S_069 | Top Lane Plates Destroyed Per-Minute Sum | game_data.tl_turret_plate_destroyed | Per-killer summed top-lane turret plates destroyed per minute bin. | sumIf(1, lanetype = 'TOP_LANE') grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | lanetype, killerid, matchid, timestamp |
| TLE_S_070 | Mid Lane Plates Destroyed Per-Minute Sum | game_data.tl_turret_plate_destroyed | Per-killer summed mid-lane turret plates destroyed per minute bin. | sumIf(1, lanetype = 'MID_LANE') grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | lanetype, killerid, matchid, timestamp |
| TLE_S_071 | Bot Lane Plates Destroyed Per-Minute Sum | game_data.tl_turret_plate_destroyed | Per-killer summed bot-lane turret plates destroyed per minute bin. | sumIf(1, lanetype = 'BOT_LANE') grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | lanetype, killerid, matchid, timestamp |
| TLE_S_072 | KDA Per-Minute Bin | derived:TLE_S_024_025_026 | Per-player KDA ratio per minute bin derived from synthetic kill/death/assist bins (with killerid key from 024 aligned to participantid). | (TLE_S_024 + TLE_S_026) / greatest(TLE_S_025, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_024, TLE_S_025, TLE_S_026 |
| TLE_S_073 | KD Per-Minute Bin | derived:TLE_S_024_025 | Per-player KD ratio per minute bin derived from synthetic kill/death bins (with killerid key from 024 aligned to participantid). | TLE_S_024 / greatest(TLE_S_025, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_024, TLE_S_025 |
| TLE_S_075 | KA Per-Minute Bin | derived:TLE_S_024_026 | Per-player KA ratio per minute bin derived from synthetic kill/assist bins (with killerid key from 024 aligned to participantid). | TLE_S_024 / greatest(TLE_S_026, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_024, TLE_S_026 |
| TLE_S_076 | Kill Participation Events Per-Minute Bin | derived:TLE_S_024_026 | Per-player takedown participation count per minute bin derived from kill and assist bins (with killerid key from 024 aligned to participantid). | TLE_S_024 + TLE_S_026 grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_024, TLE_S_026 |
| TLE_S_077 | KDA Activity Per-Minute Bin | derived:TLE_S_024_025_026 | Per-player total kill, death, and assist event activity per minute bin (with killerid key from 024 aligned to participantid). | TLE_S_024 + TLE_S_025 + TLE_S_026 grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_024, TLE_S_025, TLE_S_026 |
| TLE_S_078 | Net Takedown Margin Per-Minute Bin | derived:TLE_S_024_025_026 | Per-player net takedown margin per minute bin, positive when kill-plus-assist involvement exceeds deaths (with killerid key from 024 aligned to participantid). | TLE_S_024 + TLE_S_026 - TLE_S_025 grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_024, TLE_S_025, TLE_S_026 |
| TLE_S_079 | Vision Activity Per-Minute Bin | derived:TLE_S_027_028 | Per-player total ward kill and ward placement activity per minute bin. | TLE_S_027 + TLE_S_028 grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_027, TLE_S_028 |
| TLE_S_080 | Vision Denial Share Per-Minute Bin | derived:TLE_S_027_028 | Share of per-minute vision actions coming from ward kills rather than ward placements. | TLE_S_027 / greatest(TLE_S_027 + TLE_S_028, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_027, TLE_S_028 |
| TLE_S_081 | Item Activity Per-Minute Bin | derived:TLE_S_029_030_031 | Per-player total item destroy, purchase, and undo activity per minute bin. | TLE_S_029 + TLE_S_030 + TLE_S_031 grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_029, TLE_S_030, TLE_S_031 |
| TLE_S_082 | Net Item Purchase Actions Per-Minute Bin | derived:TLE_S_030_031 | Per-player net item purchase actions after item undos per minute bin. | TLE_S_030 - TLE_S_031 grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_030, TLE_S_031 |
| TLE_S_083 | Multi-Kill Kill Share Per-Minute Bin | derived:TLE_S_024_065_066_067_068 | Share of per-minute kills that came from multi-kill chains (with killerid keys from the source metrics aligned to participantid). | (TLE_S_065 + TLE_S_066 + TLE_S_067 + TLE_S_068) / greatest(TLE_S_024, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_024, TLE_S_065, TLE_S_066, TLE_S_067, TLE_S_068 |
| TLE_S_084 | Total Plates Destroyed Per-Minute Sum | derived:TLE_S_069_070_071 | Per-killer total turret plates destroyed across all lanes per minute bin. | TLE_S_069 + TLE_S_070 + TLE_S_071 grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_069, TLE_S_070, TLE_S_071 |
...
| TLE_S_095 | Ward Placement To Kill Ratio Per-Minute Bin | derived:TLE_S_027_028 | Ratio of ward placements to ward kills per minute bin. | TLE_S_028 / greatest(TLE_S_027, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_027, TLE_S_028 |
...
| TLE_S_099 | Top Lane Plate Share Per-Minute Bin | derived:TLE_S_069_084 | Share of per-minute plate pressure spent in top lane. | TLE_S_069 / greatest(TLE_S_084, 1) grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_069, TLE_S_084 |
| TLE_S_100 | Mid Lane Plate Share Per-Minute Bin | derived:TLE_S_070_084 | Share of per-minute plate pressure spent in mid lane. | TLE_S_070 / greatest(TLE_S_084, 1) grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_070, TLE_S_084 |
| TLE_S_101 | Bot Lane Plate Share Per-Minute Bin | derived:TLE_S_071_084 | Share of per-minute plate pressure spent in bot lane. | TLE_S_071 / greatest(TLE_S_084, 1) grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_071, TLE_S_084 |
...
| TLE_S_118 | Plate Lane Concentration Per-Minute Bin | derived:TLE_S_099_100_101 | Concentration index for per-minute plate pressure by lane, higher when plate pressure is focused into one lane within the bin. | TLE_S_099 * TLE_S_099 + TLE_S_100 * TLE_S_100 + TLE_S_101 * TLE_S_101 grouped by (matchid, killerid, intDiv(timestamp, 60000)) | 1.0.0 | TLE_S_099, TLE_S_100, TLE_S_101 |
...
- [TLE_S_024] `championKillEventsPerMinuteBin`: `count() grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_025] `championDeathEventsPerMinuteBin`: `countIf(victimid = participantid) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_026] `championAssistEventsPerMinuteBin`: `countIf(has(ifNull(assistingParticipantIds, []), participantid)) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_062] `firstBloodEventsPerMinuteBin`: `countIf(killtype = 'KILL_FIRST_BLOOD') grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_063] `aceEventsPerMinuteBin`: `countIf(killtype = 'KILL_ACE') grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_064] `multiKillEventsPerMinuteBin`: `countIf(killtype = 'KILL_MULTI') grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_027] `wardsKilledPerMinuteBin`: `countIf(type = 'WARD_KILL' AND JSONExtractInt(payload, 'killerId') = participantid) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_028] `wardsPlacedPerMinuteBin`: `countIf(type = 'WARD_PLACED' AND JSONExtractInt(payload, 'creatorId') = participantid) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_029] `itemsDestroyedPerMinuteBin`: `countIf(type = 'ITEM_DESTROYED' AND JSONExtractInt(payload, 'participantId') = participantid) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_030] `itemsPurchasedPerMinuteBin`: `countIf(type = 'ITEM_PURCHASED' AND JSONExtractInt(payload, 'participantId') = participantid) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_031] `itemUndosPerMinuteBin`: `countIf(type = 'ITEM_UNDO' AND JSONExtractInt(payload, 'participantId') = participantid) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_076] `killParticipationEventsPerMinuteBin` (new): `TLE_S_024 + TLE_S_026 grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_077] `kdaActivityPerMinuteBin` (new): `TLE_S_024 + TLE_S_025 + TLE_S_026 grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_078] `netTakedownMarginPerMinuteBin` (new): `TLE_S_024 + TLE_S_026 - TLE_S_025 grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_079] `visionActivityPerMinuteBin` (new): `TLE_S_027 + TLE_S_028 grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_081] `itemActivityPerMinuteBin` (new): `TLE_S_029 + TLE_S_030 + TLE_S_031 grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_082] `netItemPurchaseActionsPerMinuteBin` (new): `TLE_S_030 - TLE_S_031 grouped by (matchid, participantid, intDiv(timestamp, 60000))`
...
- [TLE_S_065] `doubleKillTotalKillsPerMinuteSum`: `sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 2) grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_066] `tripleKillTotalKillsPerMinuteSum`: `sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 3) grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_067] `quadraKillTotalKillsPerMinuteSum`: `sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 4) grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_068] `pentaKillTotalKillsPerMinuteSum`: `sumIf(multikilllength, killtype = 'KILL_MULTI' AND multikilllength = 5) grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_069] `topLanePlatesDestroyedPerMinuteSum`: `sumIf(1, lanetype = 'TOP_LANE') grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_070] `midLanePlatesDestroyedPerMinuteSum`: `sumIf(1, lanetype = 'MID_LANE') grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_071] `botLanePlatesDestroyedPerMinuteSum`: `sumIf(1, lanetype = 'BOT_LANE') grouped by (matchid, killerid, intDiv(timestamp, 60000))`
...
- [TLE_S_084] `totalPlatesDestroyedPerMinuteSum` (new): `TLE_S_069 + TLE_S_070 + TLE_S_071 grouped by (matchid, killerid, intDiv(timestamp, 60000))`
...
- [TLE_S_072] `kdaPerMinuteBin`: `(TLE_S_024 + TLE_S_026) / greatest(TLE_S_025, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_073] `kdPerMinuteBin`: `TLE_S_024 / greatest(TLE_S_025, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_075] `kaPerMinuteBin`: `TLE_S_024 / greatest(TLE_S_026, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_083] `multiKillKillSharePerMinuteBin` (new): `(TLE_S_065 + TLE_S_066 + TLE_S_067 + TLE_S_068) / greatest(TLE_S_024, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_080] `visionDenialSharePerMinuteBin` (new): `TLE_S_027 / greatest(TLE_S_027 + TLE_S_028, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
- [TLE_S_095] `wardPlacementToKillRatioPerMinuteBin` (new): `TLE_S_028 / greatest(TLE_S_027, 1) grouped by (matchid, participantid, intDiv(timestamp, 60000))`
...
- [TLE_S_099] `topLanePlateSharePerMinuteBin` (new): `TLE_S_069 / greatest(TLE_S_084, 1) grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_100] `midLanePlateSharePerMinuteBin` (new): `TLE_S_070 / greatest(TLE_S_084, 1) grouped by (matchid, killerid, intDiv(timestamp, 60000))`
- [TLE_S_101] `botLanePlateSharePerMinuteBin` (new): `TLE_S_071 / greatest(TLE_S_084, 1) grouped by (matchid, killerid, intDiv(timestamp, 60000))`
...
- [TLE_S_118] `plateLaneConcentrationPerMinuteBin` (new): `TLE_S_099 * TLE_S_099 + TLE_S_100 * TLE_S_100 + TLE_S_101 * TLE_S_101 grouped by (matchid, killerid, intDiv(timestamp, 60000))`
