...
# v29 adds production loadout and patch-only temporal residual features. The
# identity-encoder latents still gather per batch from the small frozen artifact.
CACHE_FORMAT = "npy-memmap-v29"
